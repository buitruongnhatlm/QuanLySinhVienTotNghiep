...
namespace DTO
{
   public class StudentDTO
    ...
    public class Student
    {
        ...
        public Student(int idsinhvien, string hoten, int masosinhvien, string gioitinh, DateTime ngaysinh, string noisinh, string diachithuongtru,
            string dantoc, string tongiao, int chungminhnhandan, DateTime ngaycap, DateTime ngayvaodoan, DateTime ngayvaodang,
            int dienthoai, string email, string ghichu, int idgiadinh, int idtaikhoan, int idthongtintotnghiep)
        {
        ...
        public Student(DataRow _row)
        {
            this.IDSinhVien = Convert.ToInt32(_row["IDSinhVien"]);
