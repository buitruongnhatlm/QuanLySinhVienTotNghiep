...
namespace DTO
{
    public class GraduateDTO
    {
        ...
        public int Diem10 { get => _Diem10; set => _Diem10 = value; }
        public int Diem4 { get => _Diem4; set => _Diem4 = value; }
        ...
        public GraduateDTO(DateTime ngayvaotruong, DateTime ngaytotnghiep, DateTime ngaycapbang, int diem10, int diem4, 
                           int idloaitotnghiep, int idhedaotao, int idnganh, int idlop, int iddiemchu, string ghichu)
        {
        ...
        public GraduateDTO(DataRow row)
        {
            ...
            this.Diem10 = Convert.ToInt32(row["Diem10"]);
            this.Diem4 = Convert.ToInt32(row["Diem4"]);
