...
namespace DAL
{
    public class GraduateDAL
    {
        ...
        public bool InsertGraduate(DateTime ngayvaotruong, DateTime ngaytotnghiep, DateTime ngaycapbang, int diem10, int diem4,
        ...
        public List<GraduateDTO> SearchGraduate(string type, string content)
        {
            ...
            else if (type.Equals("Diem10"))
            {
                _query = string.Format(" EXECUTE dbo.pro_SearchGraduate @type = 'Diem10', @content = '{0}' ", content);
            }
            else if (type.Equals("Diem4"))
            {
                _query = string.Format(" EXECUTE dbo.pro_SearchGraduate @type = 'Diem4', @content = N'{0}'  ", content);
            }
